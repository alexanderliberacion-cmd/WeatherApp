...
export const App = () => {
    ...
    return (
        <main className="bg-slate-900  flex flex-col justify-center min-w-screen min-h-screen items-center">
            <div id="width" className="max-w-7xl md:max-w-2xl mx-auto w-full px-4">
